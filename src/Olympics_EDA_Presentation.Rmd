...
# Olympics 
<br>
**EDA analysis of the Olypics games**
<br> 
*By* 
<br>
Mohammed Darwish, Salman Al-Harbi, Amal alghamdi, Abdulmalik Alrebdi
...
height, weight has a similar trend as the reach the minimum point between 1950-1960 
and they start to increase again. before that the plot shows that the athlete tend to have lower weights, the decrease in the weight is higher and faster than the height. since the events are changing constantly overall this plot implies that the new events require high height and weight.\
...
<br>
**There are only a few events that happened every year so it is hard to evaluate the attributes of the athlete without deep analysis**
<br> 
**Using git we had some issues in pushing and pulling the content and how we organize our work**
<br>
**In the early years, there is a lot of missing data**
